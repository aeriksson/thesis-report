...
context_color = (255 / 255.0, 150 / 255.0, 150 / 255.0)

plots[0].plot(T, data[0], color=context_color, linewidth=2)
...
plots[1].plot(T[center-CONTEXT_WIDTH:center+CONTEXT_WIDTH], data[1][center-CONTEXT_WIDTH:center+CONTEXT_WIDTH], color=context_color, linewidth=2)
plots[1].plot(T[center+CONTEXT_WIDTH - 1:], data[1][center+CONTEXT_WIDTH - 1:], color='0.9', linewidth=2)
...
plots[2].plot(T[:COLLECTIVE_ANOMALY_START+1], data[2][:COLLECTIVE_ANOMALY_START+1], color=context_color, linewidth=2)
plots[2].plot(T[COLLECTIVE_ANOMALY_END-1:], data[2][COLLECTIVE_ANOMALY_END-1:], color=context_color, linewidth=2)
...
plots[3].plot(T[center+CONTEXT_WIDTH:], data[3][center+CONTEXT_WIDTH:], color='0.9', linewidth=2)
plots[3].plot(T[center-CONTEXT_WIDTH - 1:COLLECTIVE_ANOMALY_START + 1], data[3][center-CONTEXT_WIDTH - 1:COLLECTIVE_ANOMALY_START + 1], color=context_color, linewidth=2)
plots[3].plot(T[COLLECTIVE_ANOMALY_END - 1:center+CONTEXT_WIDTH + 1], data[3][COLLECTIVE_ANOMALY_END - 1:center+CONTEXT_WIDTH + 1], color=context_color, linewidth=2)
