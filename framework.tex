...
\end{description}
The remainder of this chapter deals with each of these factors in turn, listing choices treated by existing methods, and introducing a few new concepts along the way.
...
TODO: Move this section to background?
